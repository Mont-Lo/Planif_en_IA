...
env = gym.make("ALE/Freeway-v5", render_mode="human", full_action_space=False) #True, 

# "rgb_array" (pour récupérer les images du jeu en tant que tableau NumPy) 🎨
...
# Source : https://blog.coddity.com/articles/ag-atari/
"""
...
"""
# 📅 Jouer au hasard option 1
"""

"""

# 📅 Jouer au hasard option 2
